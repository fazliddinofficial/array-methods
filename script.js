...
if (text === 'length') {
    ...
    var index1 = prompt("enter first index");
    var index2 = prompt('enter second index');
    var index3 = prompt('enter what you want to add').split(' ');
    arr.splice(index1, index2, index3);
